                    ...
                    <tr class="hover:bg-[#F9FAFB] transition-colors">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('admin.recipes.detail') }}" class="flex items-center gap-1 px-3 py-1.5 text-[12px] font-semibold text-[#53643A] border border-[#E5E5E5] rounded-lg hover:bg-gray-50">
