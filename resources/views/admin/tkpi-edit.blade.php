...
<div class="w-full pb-8">
    ...
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-[#1B1C18]">Edit Data Pangan</h2>
        <p class="text-[#75786D] mt-2 text-sm">Perbarui informasi komposisi dan nilai gizi standar TKPI</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white p-8 rounded-2xl border border-[#E5E5E5] shadow-sm space-y-6">
                ...
                <div>
                    ...
                    <input type="text" value="Sate Ayam Bumbu Kacang" class="w-full px-4 py-2.5 bg-[#F9FAFB] border border-[#E5E5E5] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#53643A]/20 transition-all focus:bg-white text-[#1B1C18] font-medium">
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select class="w-full px-4 py-2.5 bg-[#F9FAFB] border border-[#E5E5E5] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#53643A]/20 transition-all focus:bg-white text-[#1B1C18] font-medium">
                            <option value="olahan" selected>Olahan Matang</option>
                    ...
                    <div>
                        ...
                        <input type="text" value="1 porsi (5 tusuk)" class="w-full px-4 py-2.5 bg-[#F9FAFB] border border-[#E5E5E5] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#53643A]/20 transition-all focus:bg-white text-[#1B1C18] font-medium">
                    </div>
                </div>

                <div>
                    <label class="block text-[13px] font-semibold text-[#75786D] mb-1.5">Bahan Utama (Untuk Filter Pencarian)</label>
                    <input type="text" value="Ayam, Kacang Tanah" class="w-full px-4 py-2.5 bg-[#F9FAFB] border border-[#E5E5E5] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#53643A]/20 transition-all focus:bg-white text-[#1B1C18] font-medium">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="p-4 bg-[#F9FAFB] rounded-xl border border-[#E5E5E5]">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" value="285" class="w-full text-xl font-extrabold text-[#1B1C18] bg-transparent border-b-2 border-[#E5E5E5] focus:border-[#53643A] focus:outline-none transition-colors pb-1">
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-[#F9FAFB] rounded-xl border border-[#E5E5E5]">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" value="15" class="w-full text-xl font-extrabold text-[#1B1C18] bg-transparent border-b-2 border-[#E5E5E5] focus:border-[#53643A] focus:outline-none transition-colors pb-1">
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-[#F9FAFB] rounded-xl border border-[#E5E5E5]">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" value="12" class="w-full text-xl font-extrabold text-[#1B1C18] bg-transparent border-b-2 border-[#E5E5E5] focus:border-[#53643A] focus:outline-none transition-colors pb-1">
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-[#F9FAFB] rounded-xl border border-[#E5E5E5]">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" value="20" class="w-full text-xl font-extrabold text-[#1B1C18] bg-transparent border-b-2 border-[#E5E5E5] focus:border-[#53643A] focus:outline-none transition-colors pb-1">
                        </div>
                    </div>
                </div>
            </div>
