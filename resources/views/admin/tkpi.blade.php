...
<div class="w-full">
    ...
    <div class="flex gap-4 mb-6">
        ...
        <button class="bg-[#53643A] text-white px-5 py-2.5 rounded-xl font-medium text-sm flex items-center gap-2 hover:bg-[#3C4C25] transition-colors shadow-sm shrink-0">
